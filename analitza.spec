...
Version  : 23.08.1
Release  : 69
URL      : https://download.kde.org/stable/release-service/23.08.1/src/analitza-23.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.1/src/analitza-23.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.1/src/analitza-23.08.1.tar.xz.sig
...
%prep
%setup -q -n analitza-23.08.1
cd %{_builddir}/analitza-23.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695065790
mkdir -p clr-build
pushd clr-build
