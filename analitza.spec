...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/analitza-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/analitza-22.08.1.tar.xz.sig
...
%prep
%setup -q -n analitza-22.08.1
cd %{_builddir}/analitza-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662786308
mkdir -p clr-build
pushd clr-build
