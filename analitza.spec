...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/analitza-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/analitza-24.05.2.tar.xz.sig
...
%setup -q -n analitza-24.05.2
cd %{_builddir}/analitza-24.05.2
pushd ..
cp -a analitza-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720572829
mkdir -p clr-build
pushd clr-build
