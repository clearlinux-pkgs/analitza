...
Version  : 24.05.1
Release  : 82
URL      : https://download.kde.org/stable/release-service/24.05.1/src/analitza-24.05.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/analitza-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/analitza-24.05.1.tar.xz.sig
...
%setup -q -n analitza-24.05.1
cd %{_builddir}/analitza-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718393346
mkdir -p clr-build
pushd clr-build
