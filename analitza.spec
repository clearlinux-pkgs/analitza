...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/analitza-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/analitza-22.12.3.tar.xz.sig
...
%prep
%setup -q -n analitza-22.12.3
cd %{_builddir}/analitza-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677782050
mkdir -p clr-build
pushd clr-build
