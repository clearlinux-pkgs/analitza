...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/analitza-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/analitza-24.12.3.tar.xz.sig
...
%setup -q -n analitza-24.12.3
cd %{_builddir}/analitza-24.12.3
pushd ..
cp -a analitza-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742445633
mkdir -p clr-build
pushd clr-build
