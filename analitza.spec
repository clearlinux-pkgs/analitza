...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/analitza-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/analitza-23.08.2.tar.xz.sig
...
%prep
%setup -q -n analitza-23.08.2
cd %{_builddir}/analitza-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697240549
mkdir -p clr-build
pushd clr-build
