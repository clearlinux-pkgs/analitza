...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/analitza-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/analitza-23.08.5.tar.xz.sig
...
%prep
%setup -q -n analitza-23.08.5
cd %{_builddir}/analitza-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708384636
mkdir -p clr-build
pushd clr-build
