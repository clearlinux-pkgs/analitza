...
Version  : 24.08.1
Release  : 87
URL      : https://download.kde.org/stable/release-service/24.08.1/src/analitza-24.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/analitza-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/analitza-24.08.1.tar.xz.sig
...
%setup -q -n analitza-24.08.1
cd %{_builddir}/analitza-24.08.1
pushd ..
cp -a analitza-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726169854
mkdir -p clr-build
pushd clr-build
