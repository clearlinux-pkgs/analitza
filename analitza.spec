...
Version  : 23.08.0
Release  : 68
URL      : https://download.kde.org/stable/release-service/23.08.0/src/analitza-23.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/analitza-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/analitza-23.08.0.tar.xz.sig
...
%prep
%setup -q -n analitza-23.08.0
cd %{_builddir}/analitza-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693001415
mkdir -p clr-build
pushd clr-build
