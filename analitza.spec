...
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/analitza-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/analitza-23.04.3.tar.xz.sig
...
%prep
%setup -q -n analitza-23.04.3
cd %{_builddir}/analitza-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688844701
mkdir -p clr-build
pushd clr-build
