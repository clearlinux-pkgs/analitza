...
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/analitza-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/analitza-23.04.2.tar.xz.sig
...
%prep
%setup -q -n analitza-23.04.2
cd %{_builddir}/analitza-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686510126
mkdir -p clr-build
pushd clr-build
